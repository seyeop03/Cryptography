...
if __name__ == '__main__':
    plaintext = 0b0110111101101011 # plain text in binary format 
    key = 0b1010011100111011 # key in binary format 
    keyExp(key)
    print("Plain text is","{0:b}".format(plaintext)) 
    ciphertext = encrypt(plaintext)
    print("Encrypted text is","{0:b}".format(encrypt(plaintext))) 
    print("Decrypted cipher text is","{0:b}".format(decrypt(ciphertext)))